...
class SignInThreeScreen extends GetWidget<SignInThreeController> {
  SignInThreeScreen({Key? key}) : super(key: key);
  ...
  Widget _buildPasswordFloatingTextField() {
    return Padding(
        ...
        child: Obx(() => CustomFloatingTextField(
            ...
            contentPadding: EdgeInsets.fromLTRB(15.h, -7.v, 15.h, 51.v))));
  }

  /// Section Widget
  Widget _buildLoginButton() {
    return CustomElevatedButton(
        text: "lbl_login".tr, margin: EdgeInsets.only(left: 26.h, right: 24.h));
  }
