...
class SingUpD0neScreen extends GetWidget<SingUpD0neController> {
  SingUpD0neScreen({Key? key}) : super(key: key);
  ...
  Widget _buildCountune() {
    return CustomElevatedButton(
        text: "lbl_countune".tr, margin: EdgeInsets.symmetric(horizontal: 4.h));
  }
